    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.asset-categories.update", [$assetCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="id" value="{{ $assetCategory->id }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', $assetCategory->code) }}" required>
                @if($errors->has('code'))
