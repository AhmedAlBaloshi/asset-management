                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('license') ? 'is-invalid' : '' }}" name="license_id" id="license_id">
                            @foreach($licenses as $id => $license)
                                <option value="{{ $id }}" {{ old('license_id') == $id ? 'selected' : '' }}>{{ $license }}</option>
                            @endforeach
                        </select>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('warranty_period') ? 'is-invalid' : '' }}" type="text" name="warranty_period" id="warranty_period" value="{{ old('warranty_period', '') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('depreciation') ? 'is-invalid' : '' }}" type="text" name="depreciation" id="depreciation" value="{{ old('depreciation', '') }}">
