...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.companies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="fax">{{ trans('cruds.company.fields.fax') }}</label>
                <input class="form-control {{ $errors->has('fax') ? 'is-invalid' : '' }}" type="text" name="fax" id="fax" value="{{ old('fax', '') }}">
                @if($errors->has('fax'))
                    <span class="text-danger">{{ $errors->first('fax') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.company.fields.fax_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="postal">{{ trans('cruds.company.fields.postal') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.company.fields.postal_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="owner_name">{{ trans('cruds.company.fields.owner_name') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.company.fields.owner_name_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="user">{{ trans('cruds.company.fields.user') }}</label>
